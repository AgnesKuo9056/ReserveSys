...
public class Guesthouse implements Serializable {
   ...
   public   Guesthouse(){
    ...
    public Guesthouse(int gh_id, User owner, String gh_name, String gh_intro, String gh_address, String gh_phone, String gh_img, List<Roomtype> roomtype, String gh_examine_admin, int examine_state, String tags, Date createdAt, Date updatedAt, String grade, String gh_x, String gh_y, int status) {
        this.gh_id = gh_id;
        this.owner = owner;
