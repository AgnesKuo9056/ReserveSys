...
<div class="container">
    <div class="row">
        <div class="col-md-12 coming-soon-header">
            <a class="brand" href="../../home/main/login.jsp">
                <img src="../../assets/pages/img/logo-big.png" alt="logo" /> </a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 coming-soon-content">
            <h1>登陆失败 LOGIN__ERROR</h1>
            <p> your user_id or password are wrong,please try again later</p>
            <br>
            <form class="form-inline" action="#">
                <div class="input-group input-group-lg input-large">
                    <span class="input-group-btn">
                                <button class="btn green" type="button" onclick="javaScript:window.location.href='../../home/main/login.jsp'">
                                    返回登录
                                </button>
                            </span>
                </div>
