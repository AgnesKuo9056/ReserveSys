...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <button id="export_button" name="export_button" class="btn btn-primary">导出</button>
            <button id="print_table" name="print_table" class="btn btn-primary">打印</button>
            <button id="statistic_device" name="statistic_device" class="btn btn-primary">统计</button>
            <!--页面头更改结束====================================================================================================================-->
        </div>
...
<%@include file="device_download.jsp"%>
