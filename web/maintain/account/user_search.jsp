...
<meta charset="utf-8" />
<%--aria-hidden="true" --%>
<div class="modal fade draggable-modal" id="user_search_div" tabindex="-1" role="basic" style="display:none;">
...
<%--                        </div>--%>
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="user_search_name" name="user_search_name" class="form-control" placeholder="Enter name">
                                <div class="form-control-focus"> </div>
                            </div>
                        </div>
<%--                        <div class="form-group">--%>
