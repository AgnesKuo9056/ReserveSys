...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
            <!--页面头更改开始====================================================================================================================-->
            <input type="hidden" id="page_id" name="page_id" value="reserve_detail"/>
...
<%--            <iframe src="../../../gh_vedio/login.mp4" style="width:80%; height:500px;border:0; margin:auto;" allowfullscreen> </iframe>--%>
